...
$(document).ready(function () {
    ...
    function getTextFieldHTML() {
        ...
        var input = '<div class="form-group"> <label for="exampleInputEmail1">Email address</label> <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"></div>';
        return $('<div class="nada">').addClass('li_' + field + ' form_builder_field').html(input);
    }
    ...
    function getPreview(plain_html = '') {
        ...
        el.each(function () {
            ...
            if (data_type === 'text') {
                ...
                '          <input type="text" name="' + name + '" placeholder="' + placeholder + '" class="form-control"' + required + '/> \n' +
                '        </div>\n';
            }
            if (data_type === 'number') {
                var placeholder = $(this).find('.form_input_placeholder').val();
          ...
          //  console.log(html_head + html + html_body);
